...
from gentaxai.knowledge import retrieve  # ✅ Absolute import for retriever
...
async def chat_endpoint(query: ChatQuery):
    ...
    groq_messages = [{"role": msg["role"], "content": msg["content"]} for msg in CONVERSATIONS[session_id]]
